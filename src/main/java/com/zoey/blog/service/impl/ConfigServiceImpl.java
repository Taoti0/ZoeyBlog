...
import com.zoey.blog.dao.BlogConfigMapper;
import com.zoey.blog.entity.BlogConfig;
import com.zoey.blog.service.ConfigService;
 ...
 * @data: 2022/4/7  17:38
 * CREATE BY IDEA
 * ZoeyBlog: ConfigServiceImpl.java
 */
@Service
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteName = "Zoey's blog";
    public static final String websiteDescription = "Zoey's blog 是 SpringBoot2+Thymeleaf+Mybatis建造的个人博客网站";
    ...
    public static final String yourEmail = "he13586590560@163.com";
    public static final String yourName = "Zoey";

    public static final String footerAbout = "welcome to my blog. have fun.";
    public static final String footerICP = "粤ICP备 xxxxxx-x号";
    public static final String footerCopyRight = "@2022 十三";
